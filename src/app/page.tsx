...
import { ExternalLink, Github, Mail, Phone, MapPin, Calendar, Award, BookOpen, Briefcase, Code, GraduationCap, Target, Users, ChevronRight, Download, Menu, X } from "lucide-react";
  ...
  const skills = [
    {
      ...
      items: ["LLM Applications", "RAG", "Agentic AI", "LLM Orchestration", "Prompt Engineering", "Text-to-SQL", "Semantic Search", "Hybrid Search (BM25 + Vector)", "Embeddings"],
      level: 90,
    ...
    },
    {
      ...
      level: 92,
      description: "Core languages for backend, AI systems, and full-stack development"
    },
    {
      category: "Backend & AI Systems",
      items: ["FastAPI", "SQLAlchemy", "REST APIs", "Async Python", "Streaming (SSE)", "Multi-Tenant Architecture", "pytest"],
      level: 88,
      description: "Designing and shipping production-grade backend services for AI applications"
    },
    {
      category: "ML & NLP",
      items: ["Scikit-learn", "PyTorch", "TensorFlow", "NLP", "Deep Learning"],
      level: 85,
      description: "Classical ML and deep learning foundations underpinning applied AI work"
    },
    {
      category: "Databases",
      items: ["PostgreSQL", "SQL Server", "SQLite", "Firebase/Firestore"],
      level: 87,
      description: "Working across relational and document databases in production systems"
    },
    {
      category: "Infra & Tools",
      items: ["Docker", "Git/GitHub", "Ollama", "Hugging Face Inference API"],
      level: 83,
      description: "Deployment, version control, and local/hosted model inference"
    }
  ];
  ...
  const projects = [
    {
      ...
      description: "Multi-tenant AI analytics platform enabling natural-language Text-to-SQL queries over a 3.9GB production database (378 tables, 464 views). Built on a two-model LLM architecture that separates orchestration from constrained SQL generation, with an AST-based SQL validator and read-only execution safeguards. A hybrid semantic retrieval engine (BM25 + vector embeddings) powers schema discovery, and agentic reasoning workflows handle open-ended investigative queries with real-time streaming responses and rule-based business alerting.",
      technologies: ["RAG", "Agentic AI", "Text-to-SQL", "LLM Orchestration", "Hybrid Search (BM25 + Vector)", "FastAPI", "Docker", "SQLite"],
      type: "Flagship Project — Production AI Platform",
      impact: "100% top-3 retrieval accuracy on a 90-question benchmark · deployed with Docker, automated backups, health monitoring, structured audit logging, and a 390+ automated test suite",
      showGithub: false
    },
    {
      title: "Pathora — AI-Powered Career Assessment Platform",
      description: "Led a 5-person team building an LLM-integrated platform for CV/JD-based job-title prediction, personalized exam generation, and course recommendations. Implemented a dual-provider LLM architecture — Ollama for local inference, Hugging Face Inference API as a switchable alternative — tuned for constrained hardware (4GB VRAM), plus an LLM call tracing system for debugging JSON malformation, scoring logic, and pipeline issues.",
    ...
    },
    {
      ...
      description: "NLP pipeline over TripAdvisor and Quora Egypt datasets, handling both Arabic and English text. Implemented preprocessing and back-translation data augmentation, then benchmarked Logistic Regression, SVM, LSTM, and BERT models with an interactive Plotly/Streamlit visualization layer.",
    ...
    },
    {
      ...
      description: "Production-ready desktop Point of Sale application for restaurants and cafés. Electron + React + TypeScript frontend and FastAPI + PostgreSQL backend, structured as a Clean Architecture monorepo. Covers the full order lifecycle, multi-method payments, and cash-shift management, with a self-contained deployment (bundled PostgreSQL, PyInstaller-packaged backend) requiring no setup on the end user's machine.",
      technologies: ["Electron", "React", "TypeScript", "FastAPI", "PostgreSQL", "Clean Architecture"],
      type: "Freelance Project",
      showGithub: false
    },
    {
      title: "Production OS — Manufacturing Production Tracker",
      description: "Self-contained production and BOM-tracking system for a manufacturing client, built as a single HTML application backed by Firebase Auth and Firestore. Implements a 12-sheet data model joined on ERP codes, with role-based BOM lock/unlock and a full audit trail.",
      technologies: ["Firebase", "Firestore", "JavaScript", "Role-Based Access Control"],
      type: "Freelance Project",
      showGithub: false
    },
    {
    ...
    <div className="min-h-screen bg-background">
      ...
      <section id="hero" className="min-h-screen flex items-center justify-center pt-16 relative">
        <div className="absolute inset-0 z-0">
          <Image
            src="/hero-bg.jpg"
            alt="AI engineer working with LLM systems and data visualization dashboards"
            fill
            priority
            sizes="100vw"
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-lg md:text-xl mb-8 max-w-3xl mx-auto text-white/80 leading-relaxed">
              I build production LLM systems — combining Text-to-SQL, hybrid semantic retrieval, and agentic
              reasoning into multi-tenant AI platforms, backed by real production experience in backend
              architecture, automated testing, and deployment.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Button
                ...
                variant="outline"
                asChild
                className="px-8 bg-white/10 text-white border-white/40 hover:bg-white/20 transition-colors"
              >
                ...
                <Card className="h-full border-l-4 border-l-primary">
                  ...
                  <CardContent>
                    <p className="text-muted-foreground mb-4 leading-relaxed">
                      I'm an AI Engineer specializing in production LLM systems, Retrieval-Augmented Generation (RAG), 
                      and agentic AI. I build multi-tenant AI platforms that combine Text-to-SQL, hybrid semantic 
                      retrieval, and agentic reasoning — backed by real production experience across backend 
                      architecture (FastAPI, async Python), automated testing, and Docker deployment. I care about 
                      systems that hold up under real usage, not just working demos.
                    </p>
